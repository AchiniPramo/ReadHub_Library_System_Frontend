...
Library Management System`
    ...
    const historyColumns = [
        {
            key: 'sentAt' as keyof NotificationHistory,
            header: 'Sent At',
            render: (h: NotificationHistory) => new Date(h.sentAt).toLocaleString()
        },
        {
        ...
        {
            key: 'bookTitles' as keyof NotificationHistory,
            header: 'Books',
            render: (h: NotificationHistory) => h.bookTitles.join(', ')
        },
        {
